...
class MeetingControllerTests(
    ...
    fun deleteMeeting() {
        mvc.perform(MockMvcRequestBuilders
            .delete("/topics/$latestTopicID/meetings/$latestMeetingID")
            .contentType(MediaType.APPLICATION_JSON)
            .header("Authorization", "Bearer $latestToken"))
    ...
    fun updateMeeting() {
        ...
        mvc.perform(MockMvcRequestBuilders
            .put("/topics/$latestTopicID/meetings/$latestMeetingID")
            .contentType(MediaType.APPLICATION_JSON)
            .header("Authorization", "Bearer $latestToken")
            .content(body.toString()))
    ...
    @Test
    fun getSingleMeeting() {
        mvc.perform(MockMvcRequestBuilders
            .get("/topics/$latestTopicID/meetings/$latestMeetingID")
            .contentType(MediaType.APPLICATION_JSON)
            .header("Authorization", "Bearer $latestToken"))
            .andExpect(MockMvcResultMatchers.status().isOk)
    }
    ...
    fun getAllMeetings() {
        mvc.perform(MockMvcRequestBuilders
            .get("/topics/$latestTopicID/meetings")
            .contentType(MediaType.APPLICATION_JSON)
            .header("Authorization", "Bearer $latestToken"))
            .andExpect(MockMvcResultMatchers.status().isOk)
    }
